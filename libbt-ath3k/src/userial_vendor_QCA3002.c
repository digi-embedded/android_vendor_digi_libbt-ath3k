...
extern int hw_config(char *port_name, int uart_speed);
...
void userial_vendor_init(void)
{
    ...
    vnd_userial.speed = BLUETOOTH_UART_DEVICE_SPEED;
    ALOGI("vnd_userial.speed is %d ",vnd_userial.speed);
}
...
int userial_vendor_open(tUSERIAL_CFG *p_cfg)
{
    ...
    vnd_userial.fd = -1;
    vnd_userial.fd = hw_config(vnd_userial.port_name, vnd_userial.speed);
    if (vnd_userial.fd < -1) {
